...
The realisation of this package requires a collaborative environment that includes the potential users, and their specific requirements for processing analytical data, as well as developers and data scientist with expertise in a range of disciplines. In regards to development, we will consult experts of data management (i.e., iRODS) and Natural Language Processing, and the integration of C++ and R (a number of them are already contacted, see above).
...
For successful delivery of the package we need access to large quantities of raw data from various analytical instruments. We have secured access to data from Utrecht University and potentially the MfN Berlin. GitHub is essential for the collaborative character of the work. No additional computing facilities are envisioned at the moment. 
<!--
